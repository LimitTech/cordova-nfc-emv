...
import fr.papam.cordova.nfc.emv.ResponseUtils;
...
public class EmvParser {
     ...
     */
    public byte[] selectPaymentEnvironment() throws CommunicationException {

        // Select the PPSE or PSE directory
        return provider.transceive(new CommandApdu(CommandEnum.SELECT, PPSE, 0).toBytes());
    }
     ...
     */
    public boolean readWithPSE() throws CommunicationException {
        boolean ret = false;
